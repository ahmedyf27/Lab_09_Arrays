...
class Lab_09_ArrayStuff {
    ...
    //Generates Random Data Points for the program to use
    public static void main(String[] args) {
        ...
        System.out.println();
//Starts the average out at zero, adds the data points to get the total, then averages them
        int sum = 0;
...
//Counts the amount of times the users chosen data value occurs in the data points
        int count = 0;
        for (int value : dataPoints) {
            if (value == userValue) {
                count++;
